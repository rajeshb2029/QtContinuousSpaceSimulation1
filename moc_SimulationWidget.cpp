/****************************************************************************
** Meta object code from reading C++ file 'SimulationWidget.hpp'
**
...
#error "The header file 'SimulationWidget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 17, 15), // "resetSystemSlot"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "SimulationWidget\0resetSystemSlot\0"
};
...
void SimulationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->resetSystemSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
